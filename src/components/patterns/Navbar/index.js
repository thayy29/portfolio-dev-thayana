...
export default function Navbar() {
  ...
  return (
    <div className="flex box-border">
      <div class="mob-header fixed right-5 top-4 z-50 hidden lg:shadow-slate-900 lg-z-50 lg:w-full lg:flex">
        <button
          onClick={handleClick}
      ...
      {!toggle && (
        <div
          className="inner-navbar bg-transparent flex items-center justify-between w-full px-10 h-20
        ...
        >
          <div className="avatar-img flex items-center">
            <img
              className="rounded-full max-h-20 lg:max-h-28 lg:border-2 lg:border-slate-400"
              src="https://avatars.githubusercontent.com/u/31221444?v=4"
            ></img>
          </div>

          <div
            className="navbar text-slate-600 h-auto font-medium font-sans
       lg:w-full lg:flex lg:justify-start lg:h-3/4 lg:border-b-2 lg:border-slate-400 lg:z-40"
          >
            <ul
              className="anchor-nav flex items-center
          lg:items-baseline lg:flex-col lg:text-gray-800 lg: align-baseline lg:fixed lg:bottom-0
          lg:top-44 lg:w-1/3"
            >
              <li className="list_inner py-2 px-2">
                <a
                  className="flex items-center text-base py-3 px-2.5 leading-none border rounded border-none hover:border-transparent hover:bg-slate-100 inset-x-0 inset-y-0"
                  href="/"
                >
                  <House />
                  Home
